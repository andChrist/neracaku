            ...
            <div id="header_wrapper">
                <span id='header_logo'>
                    <a><img alt="neracaku" src="<?php echo load_img('general/icon.png')?>"/></a>
                     ...
                     <?php echo isset($username)?"<span id='header_user'>
                        <a href='http://localhost/Neracaku/wc/index.php/pkl/profil_pkl/profil_pkl_view'>$username</a> | <a>logout</a>
                        </span>":''?>
